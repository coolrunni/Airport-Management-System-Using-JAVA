...
public class UpdatePassenger extends JFrame implements ActionListener{
    ...
    UpdatePassenger()
    {
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("AMS/icons/images.jpeg"));
        Image img1 = img.getImage().getScaledInstance(300, 300, Image.SCALE_SMOOTH);
        ...
        ch.addMouseListener(new MouseAdapter ()
        {
            ...
            public void mouseClicked (MouseEvent arg0)
            {
                try
                {
                    ...
                    String ql="select * from passenger where username='"+username+"'";
                    ResultSet rest1=obj2.stm.executeQuery(ql);
                    while(rest1.next())
                    {
