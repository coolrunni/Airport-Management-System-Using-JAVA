...
public class CancelFlight extends JFrame implements ActionListener{
    ...
    CancelFlight()
    {
        ...
        l1 = new JLabel("Cancel Airlines India Flight");
        ...
        bt1.setBackground(new java.awt.Color(170,24,21));
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
            ...
            try
            {
                ...
                if(aa==1)
                {
                    JOptionPane.showMessageDialog(null, "your flight successfully cancel");
