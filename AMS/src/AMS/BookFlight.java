...
public class BookFlight extends JFrame implements ActionListener{
    ...
    BookFlight()
    {
        ...
        try
        {
            ...
            String q1 = "Select distinct Source from flight";
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("AMS/icons/pilot.jpg"));
        Image img1 = img.getImage().getScaledInstance(650, 470, Image.SCALE_SMOOTH);
        ...
        ch1.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent arg0)
            {
                ...
                try
                {
                    ...
                    String q = "Select distinct destination from flight where source='"+source+"'";
        ...
        ch6.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent arg0)
            {
                ...
                try
                {
                    ...
                    String q = "select distinct class_name from flight where source='"+source+"' and destination='"+destination+"'";
                    ResultSet rest1 = obj.stm.executeQuery(q);
                    while(rest1.next())
                    {
        ...
        ch3.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent arg0)
            {
                ...
                try
                {
                    ...
                    String q1 = "Select price from flight where source='"+source+"' and destination ='"+destination+"' and class_name ='"+classname+"'";
